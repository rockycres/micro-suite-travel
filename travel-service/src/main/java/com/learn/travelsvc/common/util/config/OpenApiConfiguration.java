package com.learn.travelsvc.common.util.config;
...
public class OpenApiConfiguration {
	...
	public GroupedOpenApi api() {
		return GroupedOpenApi.builder()
				...
				.group("travelapi-public")
				.pathsToMatch("/com/learn/travelsvc/controller/**")
				.build();
	}
	...
	public Info info() {
		return new Info()
				.title("Travel API")
				.description("API for creating travel tickets")
